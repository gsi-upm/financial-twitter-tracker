...
(function () {
	...
	var x, C = document,
		...
		Jb = {}, ub = 0,
		Za, M, cb, Oa, vb, B, ya = function () {}, ia = "div",
		R = "none",
	...
	va.prototype = {
		...
		getBBox: function () {
			...
			if (!a) {
				...
				} else a = this.htmlGetBBox(); if (b.isSVG && (b = a.width, c = a.height, d)) a.width = L(c * Y(g)) + L(b * V(g)), a.height = L(c * V(g)) + L(b * Y(g));
	...
	ra.prototype = {
		...
		buildText: function (a) {
			...
			n(c, function (c, d) {
				...
				n(h, function (c) {
					if (c !== "" || h.length === 1) {
						var m = {}, o = C.createElementNS(pa, "tspan"),
							n;
	...
	ob.prototype = {
		...
		getOffset: function () {
			...
			if (b || a.isLinked) n(e, function (b) {
				...
				for (D in f) f[D].destroy(), delete f[D]; if (m && m.text) {
