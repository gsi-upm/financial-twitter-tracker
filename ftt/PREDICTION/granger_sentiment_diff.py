...
results = open('results_diff.txt', 'w')
...
for ticker in tickers:
	...
	inicial = 0
	# print n_positivos[3] >= inicial
	# print type(n_positivos[4])
	# print n_positivos[0] > inicial
	for i in range(len(n_positivos)):
		# print i
		if (n_positivos[i] >= inicial):
			inicial = n_positivos[i]
			n_positivos[i] = 1
		else:
			inicial = n_positivos[1]
			n_positivos[i] = 0
	...
	results.write(ticker.upper() + ' & ' + str(granger_positive[1][0]['ssr_ftest'][1]) + ' & ' + 
